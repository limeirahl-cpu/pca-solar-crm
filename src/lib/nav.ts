...
export const NAV_GROUPS: NavGroup[] = [
  ...
  },
  {
    ...
    label: "Marketing",
    items: [
      { href: "/marketing", label: "Central de Marketing", icon: "📣", ready: true },
      { href: "/marketing/calendario", label: "Calendário de Conteúdo", icon: "🗓️", ready: true },
      { href: "/marketing/instagram", label: "Instagram", icon: "📷", ready: false },
      { href: "/marketing/campanhas", label: "Campanhas", icon: "🎯", ready: true },
      { href: "/marketing/criativos", label: "Criativos", icon: "🎨", ready: true },
      { href: "/marketing/leads", label: "Leads de campanhas", icon: "🧲", ready: true },
    ],
  },
  {
    key: "monitoramento",
  ...
  },
  {
    ...
    items: [
      ...
      { href: "/admin/integracoes", label: "Integrações", icon: "🔌", ready: true },
